...
func (a *RegistryLogin) Run(out io.Writer, hostname string, username string, password string, renegotiate string, insecure bool) error {
	return a.cfg.RegistryClient.Login(hostname, username, password, renegotiate, insecure)
}
